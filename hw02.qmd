...
* Assuming that observations began in 1780, develop a Bayesian model for whether Cayuga Lake will freeze in a given year, using a Bernoulli distribution. What prior distribution did you use, and how did you select it?
